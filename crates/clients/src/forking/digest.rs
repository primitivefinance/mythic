...
pub(crate) fn digest_artifacts(path: &str) -> Result<Artifacts, anyhow::Error> {
...
pub(crate) fn create_storage_layout<C: JsonRpcClient>(
    contract_data: &ContractMetadata,
    storage_layout: StorageLayout,
    db: &mut CacheDB<EmptyDB>,
    ethers_db: &mut EthersDB<Provider<C>>,
) -> Result<(), anyhow::Error> {
