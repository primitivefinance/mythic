...
pub mod profit_finder {
    ...
    impl ::ethers::core::abi::AbiDecode for ProfitFinderCalls {
        fn decode(
            ...
            if let Ok(decoded) = <AtomicCall as ::ethers::core::abi::AbiDecode>::decode(data) {
