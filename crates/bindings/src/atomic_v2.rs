...
pub mod atomic_v2 {
    ...
    impl<M: ::ethers::providers::Middleware> AtomicV2<M> {
        ...
        /// Calls the contract's `try_arbitrage_until_target_price` (0xa6b87c35)
        /// function
    ...
    /// Container type for all input parameters for the `findTrade` function
    /// with signature `findTrade(bool,uint256,uint256,uint256,uint256,uint256)`
    /// and selector `0xb9933e84`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `searchLowerPrice`
    /// function with signature `searchLowerPrice(uint256,uint256)` and selector
    /// `0x35289300`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `searchRaisePrice`
    /// function with signature `searchRaisePrice(uint256,uint256)` and selector
    /// `0x0ff5731d`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `try_arbitrage_until_target_price` function with signature
    /// `try_arbitrage_until_target_price(uint256,uint256)` and selector
    /// `0xa6b87c35`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all return fields from the `findTrade` function with
    /// signature `findTrade(bool,uint256,uint256,uint256,uint256,uint256)` and
    /// selector `0xb9933e84`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `searchLowerPrice`
    /// function with signature `searchLowerPrice(uint256,uint256)` and selector
    /// `0x35289300`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `searchRaisePrice`
    /// function with signature `searchRaisePrice(uint256,uint256)` and selector
    /// `0x0ff5731d`
    #[derive(
        Clone,
