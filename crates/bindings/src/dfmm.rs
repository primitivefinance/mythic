...
pub mod dfmm {
    ...
    /// function with signature `getNextLiquidity()` and selector `0xf3a8efe3`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `getSwapConstant`
    /// function with signature `getSwapConstant()` and selector `0x19638234`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `inited` function with
    /// signature `inited()` and selector `0x43c885ba`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// with signature `internalPrice()` and selector `0x859310b6`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `locked` function with
    /// signature `locked()` and selector `0xcf309012`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `reserveXWad` function
    /// with signature `reserveXWad()` and selector `0xf065957f`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `reserveYWad` function
    /// with signature `reserveYWad()` and selector `0x5e227d58`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `source` function with
    /// signature `source()` and selector `0x67e828bf`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// signature `swap(bytes)` and selector `0x627dd56a`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for DFMMCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <GetSwapConstantCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) = <InitedCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded) = <LockedCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::Locked(decoded));
            }
            if let Ok(decoded) = <ReserveXWadCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ReserveXWad(decoded));
            }
            if let Ok(decoded) = <ReserveYWadCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded) = <SourceCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for DFMMCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::GetSwapConstant(element) => ::ethers::core::abi::AbiEncode::encode(element),
                ...
                Self::ReserveXWad(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::ReserveYWad(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    /// Container type for all return fields from the `getSwapConstant` function
    /// with signature `getSwapConstant()` and selector `0x19638234`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    /// Container type for all return fields from the `inited` function with
    /// signature `inited()` and selector `0x43c885ba`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `locked` function with
    /// signature `locked()` and selector `0xcf309012`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `reserveXWad` function
    /// with signature `reserveXWad()` and selector `0xf065957f`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `reserveYWad` function
    /// with signature `reserveYWad()` and selector `0x5e227d58`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `source` function with
    /// signature `source()` and selector `0x67e828bf`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
