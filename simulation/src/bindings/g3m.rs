...
pub mod g3m {
    ...
    /// Container type for all input parameters for the `counter` function with
    /// signature `counter()` and selector `0x61bc221a`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// with signature `getLiquidity()` and selector `0x0910a510`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `logData` function with
    /// signature `logData()` and selector `0xbcc17dc7`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for G3MCalls {
        fn decode(
            ...
            if let Ok(decoded) = <CounterCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    /// Container type for all return fields from the `counter` function with
    /// signature `counter()` and selector `0x61bc221a`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
