...
pub mod g3m {
    ...
    impl ::ethers::core::abi::AbiDecode for G3MCalls {
        fn decode(
            ...
            if let Ok(decoded) = <get_invariantCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <get_spot_priceCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
