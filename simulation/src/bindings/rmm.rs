    ...
    impl ::core::fmt::Display for RMMEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::AmountInEventFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::AmountOutAbsEventFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::AmountOutEventFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::AmountOutEvent3Filter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::AmountOutIntEventFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                ...
                Self::SpotPriceEventFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
            }
        }
