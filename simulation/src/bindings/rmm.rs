...
pub mod rmm {
    ...
    impl ::ethers::core::abi::AbiDecode for RMMCalls {
        fn decode(
            ...
            if let Ok(decoded) = <GammaCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
