...
pub mod portfolio_registry {
    ...
    pub static PORTFOLIOREGISTRY_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(__abi);
    #[rustfmt::skip]
    const __BYTECODE: &[u8] = b"`\x80`@R4\x80\x15a\0]W`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`\"`$\x82\x01R\x7FEther sent to non-payable functi`D\x82\x01\x90\x81Ra7\xB7`\xF1\x1B`d\x83\x01R`\x84\x82\xFD[P`@Qa\x08F8\x03\x80a\x08F\x839\x81\x01`@\x81\x90Ra\0|\x91a\0\xCBV[`\0\x80T`\x01`\x01`\xA0\x1B\x03\x19\x16`\x01`\x01`\xA0\x1B\x03\x83\x16\x90\x81\x17\x82U`@Q\x83\x92\x90\x7F\x82\x92\xFC\xE1\x8F\xA6\x9E\xDFM\xB7\xB9N\xA2\xE5\x82A\xDF\n\xE5\x7F\x97\xE0\xA6\xC9\xB2\x90g\x02\x8B\xF9-v\x90\x82\x90\xA3PPa\x01FV[`\0` \x82\x84\x03\x12\x15a\x01(W`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`\"`$\x82\x01R\x7FABI decoding: tuple data too sho`D\x82\x01Ra\x1C\x9D`\xF2\x1B`d\x82\x01R`\x84\x81\xFD[\x81Q`\x01`\x01`\xA0\x1B\x03\x81\x16\x81\x14a\x01?W`\0\x80\xFD[\x93\x92PPPV[a\x06\xF1\x80a\x01U`\09`\0\xF3\xFE`\x80`@R4\x80\x15a\0]W`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`\"`$\x82\x01R\x7FEther sent to non-payable functi`D\x82\x01\x90\x81Ra7\xB7`\xF1\x1B`d\x83\x01R`\x84\x82\xFD[P`\x046\x10a\0\xAFW`\x005`\xE0\x1C\x80c\x13\xAF@5\x14a\x01\x14W\x80c\x8D\xA5\xCB[\x14a\x01)W\x80c\xA6\xCB\xE0\x97\x14a\x01XW\x80c\xE5QV\xB5\x14a\x01kW\x80c\xF3\xFE\xF3\xA3\x14a\x01~W\x80c\xF7|G\x91\x14a\x01\x91W[`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`5`$\x82\x01R\x7FContract does not have fallback `D\x82\x01\x90\x81Rtnor receive functions`X\x1B`d\x83\x01R`\x84\x82\xFD[a\x01'a\x01\"6`\x04a\x05\xDFV[a\x01\xA2V[\0[`\0Ta\x01<\x90`\x01`\x01`\xA0\x1B\x03\x16\x81V[`@Q`\x01`\x01`\xA0\x1B\x03\x90\x91\x16\x81R` \x01`@Q\x80\x91\x03\x90\xF3[a\x01'a\x01f6`\x04a\x06\x04V[a\x02 V[a\x01'a\x01y6`\x04a\x06CV[a\x03\x01V[a\x01'a\x01\x8C6`\x04a\x06CV[a\x03\xD9V[`\0T`\x01`\x01`\xA0\x1B\x03\x16a\x01<V[`\0T`\x01`\x01`\xA0\x1B\x03\x163\x14a\x01\xD5W`@QbF\x1B\xCD`\xE5\x1B\x81R`\x04\x01a\x01\xCC\x90a\x06pV[`@Q\x80\x91\x03\x90\xFD[`\0\x80T`\x01`\x01`\xA0\x1B\x03\x19\x16`\x01`\x01`\xA0\x1B\x03\x83\x16\x90\x81\x17\x82U`@Q\x90\x913\x91\x7F\x82\x92\xFC\xE1\x8F\xA6\x9E\xDFM\xB7\xB9N\xA2\xE5\x82A\xDF\n\xE5\x7F\x97\xE0\xA6\xC9\xB2\x90g\x02\x8B\xF9-v\x91\x90\xA3PV[`\0T`\x01`\x01`\xA0\x1B\x03\x163\x14a\x02JW`@QbF\x1B\xCD`\xE5\x1B\x81R`\x04\x01a\x01\xCC\x90a\x06pV[`@Qc\xDD\xA4\x07\x97`\xE0\x1B\x81R`\x01`\x01`\xA0\x1B\x03\x83\x81\x16`\x04\x83\x01R`$\x82\x01\x83\x90R\x84\x16\x90c\xDD\xA4\x07\x97\x90`D\x01`\0`@Q\x80\x83\x03\x81`\0\x87\x80;\x15\x80\x15a\x02\xE4W`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`%`$\x82\x01R\x7FTarget contract does not contain`D\x82\x01\x90\x81Rd code`\xD8\x1B`d\x83\x01R`\x84\x82\xFD[PZ\xF1\x15\x80\x15a\x02\xF8W=`\0\x80>=`\0\xFD[PPPPPPPV[`\0T`\x01`\x01`\xA0\x1B\x03\x163\x14a\x03+W`@QbF\x1B\xCD`\xE5\x1B\x81R`\x04\x01a\x01\xCC\x90a\x06pV[`@Qcx}\xCE=`\xE0\x1B\x81R`\x04\x81\x01\x82\x90R`\x01`\x01`\xA0\x1B\x03\x83\x16\x90cx}\xCE=\x90`$\x01`\0`@Q\x80\x83\x03\x81`\0\x87\x80;\x15\x80\x15a\x03\xBDW`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`%`$\x82\x01R\x7FTarget contract does not contain`D\x82\x01\x90\x81Rd code`\xD8\x1B`d\x83\x01R`\x84\x82\xFD[PZ\xF1\x15\x80\x15a\x03\xD1W=`\0\x80>=`\0\xFD[PPPPPPV[`\0T`\x01`\x01`\xA0\x1B\x03\x163\x14a\x04\x03W`@QbF\x1B\xCD`\xE5\x1B\x81R`\x04\x01a\x01\xCC\x90a\x06pV[`\0\x81\x11a\x04SW`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`\x1D`$\x82\x01R\x7FSimpleRegistry/invalid-amount\0\0\0`D\x82\x01R`d\x01a\x01\xCCV[`@Qc\xA9\x05\x9C\xBB`\xE0\x1B\x81R3`\x04\x82\x01R`$\x81\x01\x82\x90R`\x01`\x01`\xA0\x1B\x03\x83\x16\x90c\xA9\x05\x9C\xBB\x90`D\x01` `@Q\x80\x83\x03\x81`\0\x87\x80;\x15\x80\x15a\x04\xEBW`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`%`$\x82\x01R\x7FTarget contract does not contain`D\x82\x01\x90\x81Rd code`\xD8\x1B`d\x83\x01R`\x84\x82\xFD[PZ\xF1\x15\x80\x15a\x04\xFFW=`\0\x80>=`\0\xFD[PPPP`@Q=`\x1F\x19`\x1F\x82\x01\x16\x82\x01\x80`@RP\x81\x01\x90a\x05#\x91\x90a\x06\x96V[a\x05oW`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`\x1E`$\x82\x01R\x7FSimpleRegistry/transfer-failed\0\0`D\x82\x01R`d\x01a\x01\xCCV[PPV[`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`\"`$\x82\x01R\x7FABI decoding: tuple data too sho`D\x82\x01Ra\x1C\x9D`\xF2\x1B`d\x82\x01R`\x84\x81\xFD[\x805`\x01`\x01`\xA0\x1B\x03\x81\x16\x81\x14a\x05\xDAW`\0\x80\xFD[\x91\x90PV[`\0` \x82\x84\x03\x12\x15a\x05\xF4Wa\x05\xF4a\x05sV[a\x05\xFD\x82a\x05\xC3V[\x93\x92PPPV[`\0\x80`\0``\x84\x86\x03\x12\x15a\x06\x1CWa\x06\x1Ca\x05sV[a\x06%\x84a\x05\xC3V[\x92Pa\x063` \x85\x01a\x05\xC3V[\x91P`@\x84\x015\x90P\x92P\x92P\x92V[`\0\x80`@\x83\x85\x03\x12\x15a\x06YWa\x06Ya\x05sV[a\x06b\x83a\x05\xC3V[\x94` \x93\x90\x93\x015\x93PPPV[` \x80\x82R`\x0C\x90\x82\x01Rk\x15S\x90UU\x12\x13\xD4\x92V\x91Q`\xA2\x1B`@\x82\x01R``\x01\x90V[`\0` \x82\x84\x03\x12\x15a\x06\xABWa\x06\xABa\x05sV[\x81Q\x80\x15\x15\x81\x14a\x05\xFDW`\0\x80\xFD\xFE\xA2dipfsX\"\x12 UG\x19UZ\x96\x08'\xBEx\xC1\xD7\xAE\xC3C\xF6\xF8C\xAF\x15x\xE8EU\x19Kh\xFE\x99\xC1\x8DwdsolcC\0\x08\x13\x003";
    /// The bytecode of the contract.
    pub static PORTFOLIOREGISTRY_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static PORTFOLIOREGISTRY_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    /// signature `claimFee(address,address,uint256)` and selector `0xa6cbe097`
    #[derive(
        Clone,
    ...
    /// Container type for all input parameters for the `controller` function
    /// with signature `controller()` and selector `0xf77c4791`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `setFee` function with
    /// signature `setFee(address,uint256)` and selector `0xe55156b5`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// signature `withdraw(address,uint256)` and selector `0xf3fef3a3`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all return fields from the `controller` function with
    /// signature `controller()` and selector `0xf77c4791`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
