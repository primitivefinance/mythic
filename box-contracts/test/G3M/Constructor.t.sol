...
contract Constructor is SetUp {
    ...
    function test_constructor_MinWeight() public {
        g3m = new G3M(address(tokenX), address(tokenY), MIN_WEIGHT, 30);
